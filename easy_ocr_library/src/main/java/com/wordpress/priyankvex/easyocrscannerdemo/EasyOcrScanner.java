...
import com.wordpress.priyankvex.easyocrscanner.R;
...
//        String imageUri = "drawable://" + R.drawable.image;
    ...
    public void onImageTaken(String path){
        path = FileUtils.getDirectory(this.directoryPathOriginal) + File.separator + path;
        System.out.println("PathOfimage "+path);
        ImageProcessingThread thread = new ImageProcessingThread(this.mOcrScannerListener,
                path, this.directoryPathOriginal, this.mActivity, this.trainedDataCode);
        thread.execute();
        //  Users/nikhildange/AndroidStudioProjects/Easy-Ocr-Scanner-Android/app/src/main/res/mipmap-xxxhdpi/img1.png
    }
